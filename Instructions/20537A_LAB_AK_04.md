...
2.  In the **Plans** blade that opens confirm the **Virtual-MachinesX** Plan is
...
2.  Click **Microsoft.Compute (local)** and then click **Create new quota.**

3.  In the **Name** box, type **Additional-VMsX**.

4.  In the **Max number of virtual machines** box, remove **50** and then type
    **5**.

5.  Click **OK** and then click **Additional-VMsX** to select this **Quota**.
    Then click **OK**.

6.  Click **Create** to create the **Plan**.

7.  In the **Plans** blade that opens confirm the **Virtual-Machines-Add-OnX**
...
1.  In the **Azure Stack Portal**, click the settings button on the toolbar.
...
3.  Click **ContosoX** and review the information provided in the ContosoX blade
    that opens.
