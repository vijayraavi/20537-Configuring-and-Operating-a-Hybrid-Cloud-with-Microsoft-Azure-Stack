...
1.  Enter the following command to add the IP address of the privileged endpoint
...
1.  Enter the following command to store the **CloudAdminX** credentials:
...
2.  Type **Pa55w.rd** in the **Password** box and then click **OK**.

3.  Type the following commands pressing enter after each. You may need to
...
1.  Make a note of the **ClientID** that is returned.

2.  From the desktop, open the **Operator Portal** and sign in using your
    **AzureStack\\CloudAdminX** credentials.

3.  In the **Azure Stack** operator portal that opens, click **More Services**
    and then click **Subscriptions**.

4.  In the Subscriptions page that opens click Default Provider Subscription.

5.  In the **Default Provider Subscription** page that opens, make a note of the
    **Subscription ID** that is provided on the **Overview** page and then click
    **Access Control (IAM).**

6.  In the **Default Provider Subscription – Access Control (IAM)** page that
    opens, click **Add**.

7.  In the **Add permissions** page that opens, click the drop-down list next to
    **Role** and then click **Owner**.

8.  In the **Select** box, type **AzureStack-CloudAdminX**.

9.  Select the **AzureStack-CloudAdminX** account and then click **Save**.

10. Wait until the **Added user** notification appears, then click **More
    Services** and then click **User subscriptions**.

11. In the **User subscriptions** page that opens, click **ASUserXSubscription**
    where **X** is your student number.

12. In the **user subscription** page that opens, make a note of the **User
    Subscription ID** that is shown on the **Overview** page.

13. Close the **Azure Stack** operator portal.

14. Leave the **Administrator: Windows PowerShell** window open.
...
1.  Type the following command replacing the **GUID** with the **GUID** returned
...
2.  Use the up-arrow to return to the command entered in Step 1, then remove the
...
1.  From the navigation pane, under **Resource Providers**, click **Capacity**.
...
1.  Close the **S-Cluster** blade.

2.  From the navigation pane, under **Tenant Resources,** click **Virtual
    networks.**

3.  Review the information provided in the **local – Virtual networks** blade
    that opens.
