...
12. Click **Start**, type **Operations** and then click **Operations Console**.
...
3.  Note that there should be a space between the IP address and the DNS name
...
8.  Click the **Active Alerts** view.

9.  Right-click inside the view and then click **Refresh**.

10. Right-click each **Alert** and then click **Close Alert**.

11. Click the **Regions** view and then right-click the **local** Region.

12. Click Open, then click Health Explorer for local.

13. In the **Health Explorer for local** window that opens, expand the health
    monitors and then right-click the lowest level monitor and then click
    **Reset Health**.

14. In the **Reset Health** window that opens, click **Yes**.

15. Click **Close** when the task has completed and then close the **Health
    Explorer for local** window.

16. Right-click in the **Regions** view and then click **Refresh**. The
    **State** for the **local** Region should now change to **Healthy**.

17. Leave the Operations Console open.
